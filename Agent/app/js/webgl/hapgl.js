/*
	Authors: Reynier Ortiz, Mihai Polceanu
	...
	function HapGLCharacter(options) {
        ...
        */
		...
		self.emHappiness = function (intensity) {
			self.mesh.morphTargetInfluences[48] = intensity; //intensity/100;
		}

		self.emSadness = function (intensity) {
			self.mesh.morphTargetInfluences[49] = intensity; //intensity/100;
		}

		self.emSurprise = function (intensity) {
			self.mesh.morphTargetInfluences[50] = intensity; //intensity/100;
		}

		self.emAnger = function (intensity) {
			self.mesh.morphTargetInfluences[53] = intensity; //intensity/100;
		}

		self.emFear = function (intensity) {
			self.mesh.morphTargetInfluences[51] = intensity; //intensity/100;
		}
		
		self.emDisgust = function (intensity) {
			self.mesh.morphTargetInfluences[52] = intensity; //intensity/100;
		}
        
        self.setMorphTargetInfluence = function (index, intensity)
        {
            self.mesh.morphTargetInfluences[index] = intensity;
        }
